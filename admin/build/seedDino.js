...
var fantasyFights_1 = require("./fantasyFights");
var firebase_admin_1 = __importDefault(require("firebase-admin"));
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var flagArgs, args, i, app, ffc;
    var _a;
        ...
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, app
                        ...
                        .add(__assign(__assign({}, fantasyFights_1.campaign), { acl: (_a = {}, _a[flagArgs.gm] = 'admin', _a) }))];
            case 1:
                ffc = _b.sent();
                return [4 /*yield*/, Promise.all([
                        Promise.all(fantasyFights_1.characters
                            ...
                            var _a;
                            if (flagArgs.player) {
                                return __assign(__assign({}, c), { acl: (_a = {}, _a[flagArgs.player] = 'admin', _a) });
                            }
                            else {
                                return c;
                            }
                            ...
                            return app
                                ...
                                .add(__assign(__assign({}, p), { campaignId: ffc.id }));
                        })),
                    ])];
            case 2:
                _b.sent();
